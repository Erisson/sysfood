...
<title><?php echo $pagina; ?> - Sys Food</title>
...
<body class="loggedin">
	...
	<div class="header">
    	<div class="headerinner">
            ...
            <a href="" class="logo_a">Sys Food</a>            
          	...
          	<div class="mainleftinner">
              	...
              	<div class="leftmenu">
            		<ul>
                        ...
                        <li id="menu_categorias"><a href="<?php echo site_url('categorias/index'); ?>" class="widgets"><span>Categorias</span></a></li>
